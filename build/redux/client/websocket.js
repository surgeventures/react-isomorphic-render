...
var _robustWebsocket = require('../../robust-websocket');

var _robustWebsocket2 = _interopRequireDefault(_robustWebsocket);
...
function websocket(_ref) {
	...
	var _websocket = new _robustWebsocket2.default((secure ? 'wss' : 'ws') + '://' + host + ':' + port, undefined, {
	...
	var websocket = {
		send: function send(message) {
			...
			return _websocket.send((0, _stringify2.default)(message));
		},
