...
exports.default = create_http_client;
...
function create_http_client(settings, get_store, protected_cookie_value) {
	...
	if (settings.http.catch) {
		catch_to_retry = function catch_to_retry(error, retryCount, helpers) {
			return settings.http.catch(error, retryCount, (0, _extends3.default)({}, helpers, {
				store: get_store()
			}));
		};
	}
	...
	if (settings.authentication.accessToken) {
		get_access_token = function get_access_token(getCookie, helpers) {
			return settings.authentication.accessToken(getCookie, (0, _extends3.default)({}, helpers, {
				store: get_store()
			}));
		};
	}

	return new _httpClient2.default((0, _extends3.default)({
